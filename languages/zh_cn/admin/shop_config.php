...
$_LANG['cfg_name']['sms_order_placed_customer'] = '客户下订单时是否给客户发短信';
$_LANG['cfg_name']['sms_order_payed_customer'] = '客户付款时是否给客户发短信';

$_LANG['cfg_range']['sms_order_placed_customer']['1'] = '发短信';
$_LANG['cfg_range']['sms_order_placed_customer']['0'] = '不发短信';
$_LANG['cfg_range']['sms_order_payed_customer']['1'] = '发短信';
$_LANG['cfg_range']['sms_order_payed_customer']['0'] = '不发短信';
