...
html = '<div class=cardivfloat><span class=cartdivfloattitle>商品已成功添加到购物车！</span><a href=\'javascript:cancel_div()\' style="float:right;padding:0 26px 0 0;background:url(themes/68ecshop_xiaomi/images/ico_closebig1.gif) right center no-repeat;cursor:pointer;color:#ffffff;font-size:12px;" >关闭</a></div><div class="cartpopDiv"><div class="toptitle"><a href="goods.php?id='+goods_id+'" class="pic"><img src='+pic+' width="98" height="98" style="border:#dddddd 1px solid; display:block;"/></a><p><font style="font-weight:bold">'+name+'</font>  <br>'+goods_brief+'<br>购买价格：<font style="color:#cc0000">'+price+'</font><br></p></div>';
...
html +="<div class=cartbntfloat ><a href='flow.php'><img src='themes/68ecshop_xiaomi/images/jsico1.gif'></a><a href=\'javascript:cancel_div()\'><img src='themes/68ecshop_xiaomi/images/goon_ico1.gif'></a></div>";
...
/* Ecshop二次开发 JS代码增加_start  By LiuZhen at 2015/04/02 15:30 */
