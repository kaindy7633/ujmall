...
<script type="text/javascript" src="themes/68ecshop_xiaomi/js/libs/jquery18.js" ></script>
   <?php echo $this->smarty_insert_scripts(array('files'=>'jquery.json.js,transport.js,common.js,user.js')); ?>
  ...
  <div id="user_box_right">
    ...
    <div class="clearfix usBox_y" style="_height:1%;">
      ...
      <DIV id=userMRtop>
        <DIV id=i-userinfo>
          <DIV class=username>
            <DIV class="fl ftx-03"><b class="f7"><?php echo $this->_var['info']['username']; ?></b> <?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！<?php echo $this->_var['lang']['last_time']; ?>: <?php echo $this->_var['info']['last_time']; ?></DIV>
            <DIV class=extra></DIV>
          </DIV>
          <DIV class=account>
            <DIV class=member>
          ...
          <DIV class=acco-safe></DIV>
          
          <DIV id=remind>
            <DIV class=oinfo>
              <DL class=fore >
                <DT>订单提醒：</DT>
                <DD><SPAN><?php echo $this->_var['lang']['last_month_order']; ?><?php echo $this->_var['info']['order_count']; ?><?php echo $this->_var['lang']['order_unit']; ?></SPAN></DD>
              </DL>
              <DL>
                <DD style="width:380px;"><SPAN><?php echo $this->_var['rank_name']; ?><?php echo $this->_var['next_rank_name']; ?></SPAN></DD>
              </DL>
              <DL>
                <DT></DT>
                <DD>
...
?>
              ...
              <DL>
                <DT><?php echo $this->_var['lang']['please_received']; ?>：</DT>
                <DD>
    ...
    foreach ($_from AS $this->_var['item']):
?>
                  <A href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>"><SPAN><?php echo $this->_var['item']['order_sn']; ?></SPAN></A>
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </DD>
              </DL>
              <?php endif; ?>
            ...
            <DIV class=ainfo>
              <DL class=fore>
                <DT><?php echo $this->_var['lang']['your_surplus']; ?>：</DT>
                <DD><A class=flk-01 
  href="user.php?act=account_log"><SPAN><?php echo $this->_var['info']['surplus']; ?></SPAN></A></DD>
              </DL>
              <DL>
                <DT><?php echo $this->_var['lang']['your_integral']; ?>：</DT>
                <DD><A class=flk-03 
  href=""><SPAN
  class=ftx-04><?php echo $this->_var['info']['integral']; ?></SPAN></A></DD>
              </DL>
              <DL>
                <DT><?php echo $this->_var['lang']['your_bonus']; ?>：</DT>
                <DD><A 
  href="user.php?act=bonus"><SPAN
  class=ftx-04><?php echo $this->_var['info']['bonus']; ?></SPAN></A> </DD>
              </DL>
              <?php if ($this->_var['info']['credit_line'] > 0): ?>
              <DL>
                <DT><?php echo $this->_var['lang']['credit_line']; ?>：</DT>
                <DD><A><SPAN
  class=ftx-04><?php echo $this->_var['info']['formated_credit_line']; ?></SPAN></A> </DD>
              </DL>
              <?php endif; ?>
      ...
      <div style="margin:5px 0; border:1px solid #E4E4E4;padding:10px 20px; background:#fcfcfc;"> <img src="themes/68ecshop_xiaomi/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?> </div>
      <br />
      <br />
      <div class="blank"></div>
      <?php endif; ?>
        ...
        <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
          <table width="100%" border="0" cellpadding="3">
            ...
            <tr>
              ...
              <td><a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/68ecshop_xiaomi/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
            ...
            <tr>
              ...
              <td><input type="hidden" name="act" value="act_add_message" />
                <input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="bnt_bonus" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
...
?>
        <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/68ecshop_xiaomi/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <?php else: ?>
      ...
      <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['label_collection']; ?></span></h5>
...
?>
      ...
      <?php echo $this->fetch('library/pages.lbi'); ?>
      <div class="blank5"></div>
      <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['label_affiliate']; ?></span></h5>
  ...
  var select_spe = "<?php echo $this->_var['lang']['select_spe']; ?>";
      ...
      <h5 style="border-bottom:0;"><span><?php echo $this->_var['lang']['label_booking']; ?></span></h5>
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr align="center">
...
?>
    ...
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <h5 style="border-bottom:0;"><span><?php echo $this->_var['lang']['add']; ?><?php echo $this->_var['lang']['label_booking']; ?></span></h5>
      ...
      <div class="box"> <?php echo $this->_var['affiliate_intro']; ?> </div>
      <?php if ($this->_var['affiliate']['config']['separate_by'] == 0): ?>
      
      <div class="blank"></div>
      <h5 style="border-bottom:0;"><span><a name="myrecommend"><?php echo $this->_var['lang']['affiliate_member']; ?></a></span></h5>
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr align="center">
...
?>
      ...
      <div class="blank"></div>
      <h5 style="border-bottom:0;"><span>分成规则</span></h5>
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr align="center">
...
//-->
      ...
      <div class="blank"></div>
      <h5 style="border-bottom:0;"><span><?php echo $this->_var['lang']['affiliate_code']; ?></span></h5>
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr>
