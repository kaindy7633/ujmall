...
<div class="block">
  <div class="box">
  <h3 style="height:40px; text-indent:30px; line-height:40px; border:#E6E4E3 1px solid; background:#fafafa; border-bottom:none;"><span><?php echo $this->_var['lang']['system_info']; ?></span></h3>
   <div class="box_1">
