...
<SCRIPT src="themes/68ecshopcom/js/jquery-1.7.2.min.js" type=text/javascript></SCRIPT>
...
?>
      ...
      <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['profile']; ?></span></h5>
...
?>
      ...
      <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['label_bonus']; ?></span></h5>
       <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr>
...
?>
    ...
    <?php endif; ?>
       ...
       <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['label_order']; ?></span></h5>
       <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
          <tr align="center">
...
?>
       ...
       <?php echo $this->fetch('library/pages.lbi'); ?>
       <div class="blank5"></div>
       <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['merge_order']; ?></span></h5>
        <script type="text/javascript">
...
?>
      ...
      <?php if ($this->_var['action'] == 'track_packages'): ?>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['label_track_packages']; ?></span></h5>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4" id="order_table">
        <tr align="center">
          <td bgcolor="#ffffff"><?php echo $this->_var['lang']['order_number']; ?></td>
          <td bgcolor="#ffffff"><?php echo $this->_var['lang']['handle']; ?></td>
        </tr>
...
?>
      ...
      <?php if ($this->_var['action'] == order_detail): ?>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['order_status']; ?></span></h5>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
        <tr>
...
?>
        ...
        <div class="blank"></div>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['goods_list']; ?></span>
...
?>
         ...
         <div class="blank"></div>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['fee_total']; ?></span></h5>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
          <tr>
    ...
    <?php endif; ?>
         ...
         <div class="blank"></div>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['consignee_info']; ?></span></h5>
         <?php if ($this->_var['order']['allow_update_address'] > 0): ?>
          ...
          <?php endif; ?>
          <div class="blank"></div>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['payment']; ?></span></h5>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
                <tr>
                  <td bgcolor="#ffffff">
...
?>
        ...
        <div class="blank"></div>
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['other_info']; ?></span></h5>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
...
?>
        ...
        <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['user_balance']; ?></span></h5>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E4E4E4">
          <tr>
...
?>
                ...
                <tr>
                  ...
                  <td colspan="4" align="center" bgcolor="#ffffff"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
                    <input type="submit" name="submit" class="bnt_blue_1" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
                    <input name="button" type="button" class="bnt_blue_1"  onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_address']; ?>'))location.href='user.php?act=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'" value="<?php echo $this->_var['lang']['drop']; ?>" />
                    <?php else: ?>
      ...
      <?php endif; ?>
       ...
       <h5 style="border-bottom:0"><span><?php echo $this->_var['lang']['transform_points']; ?></span></h5>
