...
else
{
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_name,g.goods_number,g.is_shipping, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
		...
		if($row['shop_price'] != 0)
{
	...
	$arr[$row['goods_id']]['endtime'] = 
	
	local_date('Y年m月d日',$row['promote_end_date']);
