...
elseif ($_REQUEST['step'] == 'done')
{
   ...
   /* 判断是不是实体商品 */
    ...
    /* 插入订单商品 下面这个SQL有修改 by www.68ecshop.com 注意末尾那个字段 */
...
/* 如果需要，发短信 */
    ...
    if ($_CFG['sms_order_placed'] == '1' && $_CFG['sms_shop_mobile'] != '')
    {
		...
		$content = "您有新订单,收货人:".$order['consignee'].",电话:".$order['tel']."。【68ecshop】";
		sendSMS($_CFG['sms_shop_mobile'],$content);
    }
	//客户下订单时是否给客户发短信
	if($_CFG['sms_order_placed_customer'] == '1')
	{
		 include_once('send.php');
		 $content = '您有一条新订单，订单号为：'.$order['order_sn'].'请注意查看。【68ecshop】';
...
elseif ($_REQUEST['step'] == 'add_package_to_cart')
{
    ...
    {
        /* 添加到购物车 修改 by www.68ecshop.com 增加两个参数 */
