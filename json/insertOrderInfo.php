...
*/
	...
	$_REQUEST['user_meny'] = isset($_REQUEST['user_meny'])  ? floatval($_REQUEST['user_meny']) : 0;
	$_REQUEST['discount'] = isset($_REQUEST['discount'])  ? floatval($_REQUEST['discount']) : 0;
	...
	//if($pay_code=='balance'){
        ...
        if($user_money>$order_amount&&$_REQUEST['user_meny']>0)
        {
