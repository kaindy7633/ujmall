...
<h1><?php if ($this->_var['action'] == 'login'): ?>会员登录<?php endif; ?>
                ...
                <?php if ($this->_var['action'] == 'qpassword_name'): ?>找回密码<?php endif; ?></h1>
      ...
      <form action="user.php" method="post" class="c-form login-form">
        <fieldset>
          ...
          <div class="field auth-code">
            ...
            <img class="check-code-img" src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" alt="<?php echo $this->_var['lang']['comment_captcha']; ?>"  title="<?php echo $this->_var['lang']['captcha_tip']; ?>" onClick="this.src='captcha.php?is_login=1&'+Math.random()" height="25"/> </div>
             <?php endif; ?>
          <div class="field submit-btn">
            <input type="submit" class="c-btn-orange" onclick="member_login()" value="登 录">
            <input type="hidden" name="act" value="act_login">
        ...
        <?php endif; ?>
                    ...
                    <div class="field identifyCode">
                        <div class="c-form-search">
                            ...
                            <div class="codePhoto">
                                <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="<?php echo $this->_var['lang']['comment_captcha']; ?>" title="<?php echo $this->_var['lang']['captcha_tip']; ?>" onClick="this.src='captcha.php?'+Math.random()" height="30"/>
                            </div>
                        </div>
