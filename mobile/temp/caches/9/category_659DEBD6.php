<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:83:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:93:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:93:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1425744624;s:8:"maketime";i:1425741024;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>服饰内衣、鞋靴、童装_U+易购 - 粮贸超市网上商城  </title>
<link rel="alternate" type="application/rss+xml" title="RSS|服饰内衣、鞋靴、童装_U+易购 - 粮贸超市网上商城  " href="feed.php?cat=4" />
...
var url = 'category.php?act=ajax&category=4&&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=&order=';
$(function(){
...
$(window).scroll(function () {
  ...
  <ul class="filter-inner">
 	<li  class="filter-cur"><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list" >上架<i class="f-ico-arrow-u"></i></a></li>
    <li ><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" >更新<i class="f-ico-arrow-d"></i></a></li>
    <li ><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list" >销量<i class="f-ico-arrow-d"></i></a></li>
    <li ><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格<i class="f-ico-arrow-u"></i></a></li>
