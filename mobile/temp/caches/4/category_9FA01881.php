<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:83:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:93:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:93:"/data/home/qyu1273800001/htdocs/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1427249809;s:8:"maketime";i:1427246209;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>食品、饮料、酒_U+易购 - 粮贸超市网上商城  </title>
<link rel="alternate" type="application/rss+xml" title="RSS|食品、饮料、酒_U+易购 - 粮贸超市网上商城  " href="feed.php?cat=3" />
...
var url = 'category.php?act=ajax&category=3&&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=&order=';
$(function(){
...
$(window).scroll(function () {
  ...
  <ul class="filter-inner">
 	<li  class="filter-cur"><a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list" >上架<i class="f-ico-arrow-u"></i></a></li>
    <li ><a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" >更新<i class="f-ico-arrow-d"></i></a></li>
    <li ><a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list" >销量<i class="f-ico-arrow-d"></i></a></li>
    <li ><a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格<i class="f-ico-arrow-u"></i></a></li>
    ...
    <div class="new-pop-sel" style="display:block">
      <ul  id="brands">
      	<li><a href="javascript:get_brand('0')" id="brand_0" class="on"><span>全部</span></a></li>
			...
			<li><a href="javascript:get_brand('21')" id="brand_21" ><span>伊利</span></a></li>
				
			<li><a href="javascript:get_brand('24')" id="brand_24" ><span>金龙鱼</span></a></li>
				
			<li><a href="javascript:get_brand('25')" id="brand_25" ><span>乐恵</span></a></li>
				
			<li><a href="javascript:get_brand('26')" id="brand_26" ><span>雅客</span></a></li>
				
			<li><a href="javascript:get_brand('27')" id="brand_27" ><span>德庄</span></a></li>
				
			<li><a href="javascript:get_brand('28')" id="brand_28" ><span>广源</span></a></li>
				
			<li><a href="javascript:get_brand('29')" id="brand_29" ><span>经典王朝</span></a></li>
				
			<li><a href="javascript:get_brand('30')" id="brand_30" ><span>龙大</span></a></li>
				
			<li><a href="javascript:get_brand('31')" id="brand_31" ><span>饭扫光</span></a></li>
				
			<li><a href="javascript:get_brand('32')" id="brand_32" ><span>李锦记</span></a></li>
				
			<li><a href="javascript:get_brand('33')" id="brand_33" ><span>罗老二</span></a></li>
				
			<li><a href="javascript:get_brand('34')" id="brand_34" ><span>幺麻子</span></a></li>
				
			<li><a href="javascript:get_brand('35')" id="brand_35" ><span>乐事</span></a></li>
				
			<li><a href="javascript:get_brand('36')" id="brand_36" ><span>EGO</span></a></li>
				
			<li><a href="javascript:get_brand('37')" id="brand_37" ><span>奥利奥</span></a></li>
				
			<li><a href="javascript:get_brand('38')" id="brand_38" ><span>趣趣多</span></a></li>
				
			<li><a href="javascript:get_brand('40')" id="brand_40" ><span>MM</span></a></li>
