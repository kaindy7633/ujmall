...
b.src="https://account./pass/userInfoJsonP?userId="+this.miid+"&callback=Xmeb.App.loginNavigation.getAccountInfo";b.type="text/javascript";b.async=true;
...
var b={path:"/",domain:"."};a.UI.cookie("XM_"+this.miid+"_UN",this.data.userName,b);this.upNavigationHtml();}}},xmFocus:{init:function(e,b){var g=this;
