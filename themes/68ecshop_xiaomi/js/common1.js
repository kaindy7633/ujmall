 ...
 */
  ...
  function addToCart(goodsId, parentId)
  {
    ...
    Ajax.call(WWW_ROOW+'flow.php?step=add_to_cart_qk', 'goods=' + $.toJSON(goods), addToCartResponse, 'POST', 'JSON');
  }
  ...
  function addToCart_coqu(goodsId, parentId)
  {
    ...
    if($("pro")) document.body.appendChild(newdiv);
    if($("ajaxload")) $("ajaxload").style.display="block";
    Ajax.call(WWW_ROOW+'flow_coqu.php?step=add_to_cart_qk', 'goods=' + $.toJSON(goods), addToCartResponse_coqu, 'POST', 'JSON');
  }
